...
export const EXPERIENCE = [
  {
    ...
    time: "2025 — Present",
    bullets: [
      "Built full-stack apps using React, Spring Boot, MongoDB.",
      "Implemented JWT authentication, REST APIs and responsive UI.",
      "Deployed apps on Netlify / Heroku / Vercel."
    ]
  },
  {
    company: "DUCAT Gurgaon",
    role: "Java Full Stack Developer Course",
    time: "2024 — 2025",
    bullets: [
      "Completed 1-year intensive Java Full Stack training.",
      "Learned Java, Spring Boot, Hibernate, REST APIs, and React.",
      "Built multiple projects to gain hands-on experience."
    ]
  }
];
...
export const PROJECTS = [
  ...
  },
  {
    ...
    desc: "Manage tasks with project categorization, due dates, priority levels, and real-time updates.",
    tech: ["React", "Spring Boot", "PostgreSQL", "JWT", "Tailwind"],
